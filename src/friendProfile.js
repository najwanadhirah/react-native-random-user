  ...
  componentWillMount() {
    ...
    db.transaction((tx) => {
      ...
      tx.executeSql(sql, [], (tx, results) => {
        ...
        const firstname = results.rows.item(0).firstname;
        const secondname = results.rows.item(0).secondname;
        const email = results.rows.item(0).email;
        const address = results.rows.item(0).address;
        const gender = results.rows.item(0).gender;
        const phone = results.rows.item(0).phone;
        const image = results.rows.item(0).image;
            ...
            <ScrollView>
              <View style={{ flexDirection: 'row', width: "100%", marginTop: 15, }}>
                ...
                <View style={styles.firstRow}>
                  <Text style={{ color: "white", fontSize: 13, fontWeight: '500' }}>Welcome,  {this.state.title} {this.state.firstname} !</Text>
                     ...
                     <View style ={{ marginTop:10, marginLeft :40 }}>
                          ...
                          style={{ paddingTop: 0, width: "80%" , marginTop:12,  flexDirection: 'row',}}>
                                   <Icon name='user' size={18} type='font-awesome' color='#144563' />
                                      <Text style={{ marginLeft : 10}}> {this.state.title} {this.state.firstname} {this.state.secondname} </Text>
                           </View>
                          ...
                          style={{ paddingTop: 0, width: "80%" , marginTop:12,  flexDirection: 'row',}}>
                                   <Icon name='venus-mars' size={18} type='font-awesome' color='#144563' />
                                      <Text style={{ marginLeft : 10}}>{this.state.gender}</Text>
                           </View>

                           <View 
                          style={{ paddingTop: 0, width: "80%" , marginTop:12,  flexDirection: 'row', marginBottom:20}}>
